...
- [`service-worker-loader`](https://www.npmjs.com/package/service-worker-loader) allows import service worker as module. For example: with this loader you can write service workers in TypeScript
